        ...
        public bool InitializeShaders(Func<string, string> GetAppData)
        {
            ...
            try
            {
                mMetaphorShaders = new()
                {
                    ...
                    { ResourceType.MaterialParameterSetType4, GLShaderProgram.TryThrowOnFail( GetAppData( "shaders/metaphor_distort.glsl.vs" ), GetAppData( "shaders/metaphor_distort.glsl.fs" )) },
